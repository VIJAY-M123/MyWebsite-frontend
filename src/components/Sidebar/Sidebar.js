...
export default function Sidebar({props, children }) {
    ...
    const getBrandText = () => {
        for (let i = 0; i < menuItem.length; i++) {
         console.log("U",menuItem[i]);
         if (
            props.location.pathname.indexOf(menuItem[i].path) !==
            -1
          ) {
            return menuItem[i].name;
          }
        }
        return "Brand";
      };
    ...
    return (
        ...
        <div className="containers" data-theme={auth.theme}>
            ...
            <main style={{
                width: isopen ? "81%" : "100%", height: "auto", backgroundColor: "var(--index-bg)",
